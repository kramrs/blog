<template>
	<n-modal class="bg" v-model:show="dialogVisible" preset="dialog" :show-icon="false" transform-origin="center"
			 :block-scroll="false" :mask-closable="false" :onAfterEnter="open">
		...
		<n-input class="mt-11" v-model:value="loginForm.code" placeholder="验证码" style="width: 63%"
				 @keyup.enter="handleLogin"></n-input>
		<img :src="captcha" alt="codeImage" @click="initCaptcha" class="mt-11 login-code-img"/>
