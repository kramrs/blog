      ...
      <el-tab-pane label="author">
        ...
        <el-form label-width="80px" :model="siteConfig" label-position="left">
          ...
          <el-form-item label="关于我">
            <MdEditor ref="editorRef" v-model="siteConfig.aboutMe"
                      :theme="isDark ? 'dark' : 'light'" showCodeRowNumber autoDetectCode
                      class="md-container" :toolbars="toolbars" :footers="footers" @on-upload-img="uploadImg"
                      placeholder="请输入内容..." height="400px">
            ...
            <el-col :span="8">
              <el-form-item label="归档">
                <el-upload class="avatar-uploader" :headers="authorization" action="/api/admin/site/upload"
                  ...
                  <img v-if="siteConfig.archiveWallpaper" :src="siteConfig.archiveWallpaper" class="article-cover"/>
                  <el-icon v-else class="avatar-uploader-icon">
                    <Plus/>
                  </el-icon>
                </el-upload>
            ...
            <el-col :span="8">
              <el-form-item label="分类">
                <el-upload class="avatar-uploader" :headers="authorization" action="/api/admin/site/upload"
                  ...
                  <img v-if="siteConfig.categoryWallpaper" :src="siteConfig.categoryWallpaper" class="article-cover"/>
                  <el-icon v-else class="avatar-uploader-icon">
                    <Plus/>
                  </el-icon>
                </el-upload>
            ...
            <el-col :span="8">
              <el-form-item label="标签">
                <el-upload class="avatar-uploader" :headers="authorization" action="/api/admin/site/upload"
                  ...
                  <img v-if="siteConfig.tagWallpaper" :src="siteConfig.tagWallpaper" class="article-cover"/>
                  <el-icon v-else class="avatar-uploader-icon">
                    <Plus/>
                  </el-icon>
                </el-upload>
            ...
            <el-col :span="8">
              <el-form-item label="说说">
                <el-upload class="avatar-uploader" :headers="authorization" action="/api/admin/site/upload"
                  ...
                  <img v-if="siteConfig.talkWallpaper" :src="siteConfig.talkWallpaper" class="article-cover"/>
                  <el-icon v-else class="avatar-uploader-icon">
                    <Plus/>
                  </el-icon>
                </el-upload>
            ...
            <el-col :span="8">
              <el-form-item label="相册&照片">
                <el-upload class="avatar-uploader" :headers="authorization" action="/api/admin/site/upload"
                  ...
                  <img v-if="siteConfig.albumWallpaper" :src="siteConfig.albumWallpaper" class="article-cover"/>
                  <el-icon v-else class="avatar-uploader-icon">
                    <Plus/>
                  </el-icon>
                </el-upload>
            ...
            <el-col :span="8">
              <el-form-item label="友链">
                <el-upload class="avatar-uploader" :headers="authorization" action="/api/admin/site/upload"
                  ...
                  <img v-if="siteConfig.friendWallpaper" :src="siteConfig.friendWallpaper" class="article-cover"/>
                  <el-icon v-else class="avatar-uploader-icon">
                    <Plus/>
                  </el-icon>
                </el-upload>
            ...
            <el-col :span="8">
              <el-form-item label="留言板">
                <el-upload class="avatar-uploader" :headers="authorization" action="/api/admin/site/upload"
                  ...
                  <img v-if="siteConfig.messageWallpaper" :src="siteConfig.messageWallpaper" class="article-cover"/>
                  <el-icon v-else class="avatar-uploader-icon">
                    <Plus/>
                  </el-icon>
                </el-upload>
            ...
            <el-col :span="8">
              <el-form-item label="关于">
                <el-upload class="avatar-uploader" :headers="authorization" action="/api/admin/site/upload"
                  ...
                  <img v-if="siteConfig.aboutWallpaper" :src="siteConfig.aboutWallpaper" class="article-cover"/>
                  <el-icon v-else class="avatar-uploader-icon">
                    <Plus/>
                  </el-icon>
                </el-upload>
