<template>
  <div class="app-container">
    ...
    <!-- 文章内容 -->
    <MdEditor ref="editorRef" :editorId="editorId" v-model="articleForm.articleContent"
      ...
      <template #defToolbars>
        ...
        <Emoji :emojis="emojis"/>
        <ExportPDF :modelValue="articleForm.articleContent" height="700px" @onSuccess="onSuccess"
